...
public class SearchActivity extends AppCompatActivity implements MobvoiApiClient.OnConnectionFailedListener,
        MobvoiApiClient.ConnectionCallbacks, NodeApi.NodeListener, MessageApi.MessageListener {

    private static final String TAG = "SearchActivity";
    private static final String START_ACTIVITY_PATH = "/start-search";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartSearchBtn = (Button) findViewById(R.id.start_search);
    ...
    public void onMessageReceived(MessageEvent event) {
        if (event.getPath().equals("/search_result")) {
            ...
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    mResultTv.setTextSize(15);
                    mResultTv.setText(datas);
                }
            });
        }
    }
