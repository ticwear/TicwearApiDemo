...
public class VoiceInputActivity extends AppCompatActivity implements MobvoiApiClient.OnConnectionFailedListener,
    ...
    private static final String START_ACTIVITY_PATH = "/start-voice";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartVoiceBtn = (Button) findViewById(R.id.start_voice);
        mVoiceTv = (TextView) findViewById(R.id.voice_text);
    ...
    public void onMessageReceived(MessageEvent event) {
        if (event.getPath().equals("/voice")) {
            ...
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    mVoiceTv.setText(getString(R.string.voice_now) + datas);
                }
            });
        }
    }
